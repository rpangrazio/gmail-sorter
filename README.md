...
- Implemented secondary PRD gap-remediation Task 19.9 for DLQ attempt tracking accuracy:
  - Updated `gmail_sorter/utils/retry.py` to annotate retry-exhausted exceptions with concrete `retry_attempts` metadata before re-raise
